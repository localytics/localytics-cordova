...
public class LLLocationListener implements com.localytics.android.LocationListener {

    private CallbackContext callbackContext;

    public LLLocationListener(CallbackContext callbackContext) {
