...
public class LLMessagingListener implements com.localytics.android.MessagingListenerV2 {
    ...
    public LLMessagingListener(CallbackContext callbackContext, SparseArray<InAppCampaign> inAppCampaignCache,
