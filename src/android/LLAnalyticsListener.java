...
public class LLAnalyticsListener implements com.localytics.android.AnalyticsListener {

    private CallbackContext callbackContext;

    public LLAnalyticsListener(CallbackContext callbackContext) {
